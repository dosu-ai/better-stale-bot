...
| --------- | ------- | ------- |
| `days-before-stale` | Minimum days of inactivity (no qualifying comment, edit, or label change) before an issue may be marked stale | 0.00001 |
| `days-before-close` | Minimum days after the `Stale` label is applied before an issue may be closed, if there is still no non-bot activity | 0.00001 |
